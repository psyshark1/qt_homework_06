    ...
    , ui(new Ui::MainWindow)
{
   ...
   concurRace2 = new ExampleRace(&m);
    ...
    connect(&whFutrace1, &QFutureWatcher<void>::finished, this, [&]
            {
                futrace2 = QtConcurrent::run(&ExampleRace::DoWork, concurRace2, &number, false, ui->sb_initNum->value());
                whFutrace2.setFuture(futrace2);
            });
}
...
void MainWindow::StartRace(void){
    ...
    if(ui->rb_qtConcur->isChecked()){
        ...
        futrace1 = QtConcurrent::run(&ExampleRace::DoWork, concurRace1, &number, false, ui->sb_initNum->value());
        whFutrace1.setFuture(futrace1);
    }
    else{
